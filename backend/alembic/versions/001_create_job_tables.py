...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("source_type", postgresql.ENUM("api", "rss", "scrape", "manual", "aggregator", name="source_type", schema="career", create_type=False), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("location_type", postgresql.ENUM("remote", "onsite", "hybrid", name="location_type", schema="career", create_type=False), nullable=True),
        ...
        sa.Column("experience_level", postgresql.ENUM("entry", "mid", "senior", "lead", "executive", name="experience_level", schema="career", create_type=False), nullable=True),
        ...
        sa.Column("salary_currency", postgresql.ENUM("USD", "EUR", "GBP", "INR", "CAD", "AUD", "JPY", "CNY", "OTHER", name="salary_currency", schema="career", create_type=False), nullable=True),
        ...
        sa.Column("employment_type", postgresql.ENUM("full_time", "part_time", "contract", "temporary", "internship", "freelance", "other", name="employment_type", schema="career", create_type=False), nullable=True),
        ...
        sa.Column("status", postgresql.ENUM("active", "filled", "expired", "draft", "closed", name="job_status", schema="career", create_type=False), server_default=sa.text("'active'"), nullable=False),
